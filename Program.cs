...
namespace ConsoleApplication2
{
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (facing == Facing.None)
                    {
                        ...
                        Console.WriteLine($"Dead! {board.Snake.Points.Length} Length in {ticks} ticks.");
                        break;
                    }
                ...
                if (board.Snake.Points.Length > 200)
                    Console.ReadLine();
            }
        }
    ...
    public class Snake
    {
        public Snake(int x, int y, Facing facing)
        {
            ...
            Points = new FacingPoint[] { facingPoint, null };
            PointsHash = new int[] { facingPoint.hashCodeNoFacing, -1 };
        }
        ...
        public FacingPoint[] Points { get; set; }
        private int[] PointsHash { get; set; }

        public bool ContainsPoint(Point point)
        {
            var pointHashCodeNoFacing = point.hashCodeNoFacing;
            var pointsHashCount = PointsHash.Length;
